...
@lombok.CustomArgsConstructor(exclude = "x") class CustomArgsConstructor {
  int x;
  String name;
  String description;
  public @java.beans.ConstructorProperties({"name", "description"}) @java.lang.SuppressWarnings("all") CustomArgsConstructor(final String name, final String description) {
    super();
    this.name = name;
